...
$config['base_url'] = 'https://dev.zukan.cloud/';
// アップ用のディレクトリ
//$config['file_upload_dir'] = '/home/sites/www.zukan.cloud/wwwroot/zukanprj/html/files/';
$config['file_upload_dir'] = '/var/www/zukanprj/web/files/';

$config['api_type_add_id'] = 1;

$config['app_sv_maintenance_mode'] = 0;// 0,OFF 1,ON
$config['app_sv_maintenance_redirect_url'] = 'http://www.zukan.cloud/mente.php';// メンテページURL
