    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                {else}
                    <p class="dropdown-item text-center small text-gray-500">No Alert</p>
                {/if}
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                {else}
                    <p class="dropdown-item text-center small text-gray-500">No message</p>
                {/if}
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">{$userData.fb_name}さん</span>
                <img class="img-profile rounded-circle" src="{$userData.fb_picture_url}">
            </a>
            ...
            {else}
                <a href="/logout/bye/" class="btn btn-primary btn-circle">TOP</a>
            {/if}
        </li>
